                ...
                for($i=0; $i < $soSanPham; $i++)
                {
                    ...
                    <form action="pages/Giohang/xlCapNhatGioHang.php" name="frmGioHang" method="post">
                        <tr>
                            ...
                            <td align="center">
                                <img src="image/img/<?php echo $row["HinhURL"]; ?>" width= "50">
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="submit" value="Cập nhật số lượng" class="btn btn-primary stretched-link"/>
                                
                                <form action="pages/Giohang/xlCapNhatGioHang.php" method="post">
                                    <input type="hidden" name="hdID" value="<?php echo $gioHang->listProduct[$i]->id; ?>"/>
                                    <input type="submit" class="btn btn-primary stretched-link" style="margin-top:5px;margin-left:15px" value="Hủy sản phẩm"></input>
                                </form>
                            </td>
                        </tr>
                    </form>
